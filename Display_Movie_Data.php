...
$QueryMovie = "select * from Movies WHERE IDMovies='".$submitted_array[0]."';";
...
echo '
<form class="form-horizontal" role="form" method="post" action="Update_filmes.php" enctype="multipart/form-data">
<table width="100%">
   <tr>
...
if ($_SESSION["Nivel"] == "F"){
	if (isset($_POST['action_button'])){
			...
			echo '<div class="form-group">
					<div class="col-sm-10 col-sm-offset-2">
						<input id="submit" type="submit" value="Habilitar" name="enable_button['.$submitted_array[0].']">
					</div>
				</div>
			</form>
			</div>
			...
			echo '<div class="form-group">
					<div class="col-sm-10 col-sm-offset-2">
						<input id="submit" type="submit" value="Desabilitar" name="disable_button['.$submitted_array[0].']">
					</div>
				</div>
			</form>
			</div>

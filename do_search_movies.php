...
if ($_SESSION["DisplayDisabled"] == "Y"){
	$SQLQuery="SELECT * FROM Movies WHERE Name LIKE'%".$_POST['name']."%' AND ID_Source LIKE '%".$_POST['idorigem']."%' AND ID_Category LIKE '%".$_POST['idcategoria']."%' AND ID_Classific LIKE'%".$_POST['idclassificacao']."%' AND ID_Midia LIKE '%".$_POST['IDMidia']."%' AND Year LIKE '%".$_POST['ano']."%' AND Sinopse LIKE '%".$_POST['sinopse']."%' AND IDMovies LIKE '%".$_POST['IDM']."%' AND Status LIKE '%".$_POST['Status']."%';";
}else{
	if ($_POST['Status'] == 'D'){
		$SQLQuery="SELECT * FROM Movies WHERE Name LIKE'%".$_POST['name']."%' AND ID_Source LIKE '%".$_POST['idorigem']."%' AND ID_Category LIKE '%".$_POST['idcategoria']."%' AND ID_Classific LIKE'%".$_POST['idclassificacao']."%' AND ID_Midia LIKE '%".$_POST['IDMidia']."%' AND Year LIKE '%".$_POST['ano']."%' AND Sinopse LIKE '%".$_POST['sinopse']."%' AND IDMovies LIKE '%".$_POST['IDM']."%' AND Status='D';";
	}else{
		$SQLQuery="SELECT * FROM Movies WHERE Name LIKE'%".$_POST['name']."%' AND ID_Source LIKE '%".$_POST['idorigem']."%' AND ID_Category LIKE '%".$_POST['idcategoria']."%' AND ID_Classific LIKE'%".$_POST['idclassificacao']."%' AND ID_Midia LIKE '%".$_POST['IDMidia']."%' AND Year LIKE '%".$_POST['ano']."%' AND Sinopse LIKE '%".$_POST['sinopse']."%' AND IDMovies LIKE '%".$_POST['IDM']."%' AND Status='E';";
	}
}
...
echo "<form action='Display_Movie_Data.php' method='post'>
	...
	while($Movie_id = $SQLServerParameterFetch($Movies)) {
		...
		if ($_SESSION["Nivel"] == "F"){
			...
			if ($Movie_id['Status'] == 'E'){
				echo "<td><input type='submit' value='Dis.' name='disable_button[".$Movie_id['IDMovies']."]'></td>\n";
				$Color = "black";
			} else {
